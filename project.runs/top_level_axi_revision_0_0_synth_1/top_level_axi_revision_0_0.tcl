...
namespace eval ::optrace {
  variable script "/home/user/Documents/Nexys/nexys_template/project.runs/top_level_axi_revision_0_0_synth_1/top_level_axi_revision_0_0.tcl"
...
OPTRACE "top_level_axi_revision_0_0_synth_1" START { ROLLUP_AUTO }
...
set_param ips.modRefOverrideMrefDirPath /home/user/Documents/Nexys/nexys_template/project.gen/sources_1/bd/mref
...
read_verilog /home/user/Documents/Nexys/nexys_template/src/revision_history.vh
read_verilog -library xil_defaultlib /home/user/Documents/Nexys/nexys_template/src/common/axi_revision.v
read_ip -quiet /home/user/Documents/Nexys/nexys_template/project.srcs/sources_1/bd/top_level/ip/top_level_axi_revision_0_0/top_level_axi_revision_0_0.xci
...
set cached_ip [config_ip_cache -export -no_bom  -dir /home/user/Documents/Nexys/nexys_template/project.runs/top_level_axi_revision_0_0_synth_1 -new_name top_level_axi_revision_0_0 -ip [get_ips top_level_axi_revision_0_0]]
...
synth_design -top top_level_axi_revision_0_0 -part xc7a100tcsg324-1 -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix top_level_axi_revision_0_0_ top_level_axi_revision_0_0.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ top_level_axi_revision_0_0_stub.v
 lappend ipCachedFiles top_level_axi_revision_0_0_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ top_level_axi_revision_0_0_stub.vhdl
 lappend ipCachedFiles top_level_axi_revision_0_0_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ top_level_axi_revision_0_0_sim_netlist.v
 lappend ipCachedFiles top_level_axi_revision_0_0_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ top_level_axi_revision_0_0_sim_netlist.vhdl
 lappend ipCachedFiles top_level_axi_revision_0_0_sim_netlist.vhdl
 set TIME_taken [expr [clock seconds] - $TIME_start]

 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp top_level_axi_revision_0_0.dcp -move_files $ipCachedFiles   -synth_runtime $TIME_taken  -ip [get_ips top_level_axi_revision_0_0]
 }
...
rename_ref -prefix_all top_level_axi_revision_0_0_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef top_level_axi_revision_0_0.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "top_level_axi_revision_0_0_synth_1_synth_report_utilization_0" "report_utilization -file top_level_axi_revision_0_0_utilization_synth.rpt -pb top_level_axi_revision_0_0_utilization_synth.pb"
OPTRACE "synth reports" END { }

if { [catch {
  file copy -force /home/user/Documents/Nexys/nexys_template/project.runs/top_level_axi_revision_0_0_synth_1/top_level_axi_revision_0_0.dcp /home/user/Documents/Nexys/nexys_template/project.gen/sources_1/bd/top_level/ip/top_level_axi_revision_0_0/top_level_axi_revision_0_0.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub /home/user/Documents/Nexys/nexys_template/project.gen/sources_1/bd/top_level/ip/top_level_axi_revision_0_0/top_level_axi_revision_0_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub /home/user/Documents/Nexys/nexys_template/project.gen/sources_1/bd/top_level/ip/top_level_axi_revision_0_0/top_level_axi_revision_0_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim /home/user/Documents/Nexys/nexys_template/project.gen/sources_1/bd/top_level/ip/top_level_axi_revision_0_0/top_level_axi_revision_0_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim /home/user/Documents/Nexys/nexys_template/project.gen/sources_1/bd/top_level/ip/top_level_axi_revision_0_0/top_level_axi_revision_0_0_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force /home/user/Documents/Nexys/nexys_template/project.runs/top_level_axi_revision_0_0_synth_1/top_level_axi_revision_0_0_stub.v /home/user/Documents/Nexys/nexys_template/project.gen/sources_1/bd/top_level/ip/top_level_axi_revision_0_0/top_level_axi_revision_0_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /home/user/Documents/Nexys/nexys_template/project.runs/top_level_axi_revision_0_0_synth_1/top_level_axi_revision_0_0_stub.vhdl /home/user/Documents/Nexys/nexys_template/project.gen/sources_1/bd/top_level/ip/top_level_axi_revision_0_0/top_level_axi_revision_0_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /home/user/Documents/Nexys/nexys_template/project.runs/top_level_axi_revision_0_0_synth_1/top_level_axi_revision_0_0_sim_netlist.v /home/user/Documents/Nexys/nexys_template/project.gen/sources_1/bd/top_level/ip/top_level_axi_revision_0_0/top_level_axi_revision_0_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /home/user/Documents/Nexys/nexys_template/project.runs/top_level_axi_revision_0_0_synth_1/top_level_axi_revision_0_0_sim_netlist.vhdl /home/user/Documents/Nexys/nexys_template/project.gen/sources_1/bd/top_level/ip/top_level_axi_revision_0_0/top_level_axi_revision_0_0_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir /home/user/Documents/Nexys/nexys_template/project.ip_user_files/ip/top_level_axi_revision_0_0]} {
  catch { 
    file copy -force /home/user/Documents/Nexys/nexys_template/project.gen/sources_1/bd/top_level/ip/top_level_axi_revision_0_0/top_level_axi_revision_0_0_stub.v /home/user/Documents/Nexys/nexys_template/project.ip_user_files/ip/top_level_axi_revision_0_0
  }
}

if {[file isdir /home/user/Documents/Nexys/nexys_template/project.ip_user_files/ip/top_level_axi_revision_0_0]} {
  catch { 
    file copy -force /home/user/Documents/Nexys/nexys_template/project.gen/sources_1/bd/top_level/ip/top_level_axi_revision_0_0/top_level_axi_revision_0_0_stub.vhdl /home/user/Documents/Nexys/nexys_template/project.ip_user_files/ip/top_level_axi_revision_0_0
  }
}
file delete __synthesis_is_running__
close [open __synthesis_is_complete__ w]
OPTRACE "top_level_axi_revision_0_0_synth_1" END { }
