...
HD_PWD='/home/user/Documents/Nexys/nexys_template/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_wrapper.vds -m64 -tempDir /tmp -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_level_wrapper.tcl
